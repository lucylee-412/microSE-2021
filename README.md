...
- **Lucy**
  - Created a button on Quiz.html (renamed; originally VolunterApp.html) and characters.js script that generates a random image. Currently not working as intended, but I will figure something out.
